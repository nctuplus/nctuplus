...
@curriculars.each do |curricular|
    NewcomerClub.create!(curricular)
end
...
@studentAssociations.each do |studentAssociation|
    NewcomerClub.create!(studentAssociation)
end
...
@alumnians.each do |alumnian|
    NewcomerClub.create!(alumnian)
end
